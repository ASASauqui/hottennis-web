...
function Tile({ id, title, brand, price, src, backgroundColor, textColor, onClick }) {
    ...
    return (
        <>
            <div className={"flex flex-col flex-shrink-0 m-6 relative overflow-hidden rounded-lg max-w-xl h-[320px] shadow-lg"} style={{ backgroundColor: backgroundColor }} onClick={onClick.bind(this, id)}>
