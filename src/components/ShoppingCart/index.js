...
function ShoppingCart() {
    ...
    return (
        <>
            <div className="fixed z-50 top-0 left-0 w-full h-full bg-black bg-opacity-50 " id="overlay">

                <div className="w-full absolute z-50 right-0 h-full overflow-y-auto overflow-x-hidden transform translate-x-0 transition ease-in-out duration-700" id="checkout">
                    <div className="flex items-end lg:flex-row flex-col justify-end" id="cart">
                        <div className="lg:w-1/2 md:w-8/12 w-full lg:px-8 lg:py-14 md:px-6 px-4 md:py-8 py-4 bg-white overflow-x-hidden lg:h-screen h-auto" id="scroll">
                            <div className="flex items-center text-gray-500 hover:text-gray-600 cursor-pointer" onclick="checkoutHandler(false)">
                            ...
                            <div className="flex items-center justify-between border-t border-gray-50 py-8 gap-10">
                                <RippleButton text="Vaciar carrito" type="button" color="bg-red-500" textColor="text-white" />
